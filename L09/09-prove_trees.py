...
class BST:
    ...
    def _contains(self, data, node):
        ...
        """
        if node is None:
            # If the current node is None, the data is not found
            return False
        ...
        if data == node.data:
            ...
            # The data might be in the left subtree
            return self._contains(data, node.left)
        else:
            # The data might be in the right subtree
    ...
    def _traverse_backward(self, node):
        ...
        if node is not None:
            yield from self._traverse_backward(node.right)  # Traverse right first
            yield node.data
            yield from self._traverse_backward(node.left)  # Traverse left last
    ...
    def _get_height(self, node):
        ...
        """
        if node is None:
            # If the current node is None, the height is 0
            return 0
        else:
