...
class LinkedList:
    ...
    def insert_tail(self, value):
        ...
        if self.head is None:
            ...
            # Update the new node's prev pointer to point to the current tail
    ...
    def remove_tail(self):
        ...
        # If the list has only one item in it, set head and tail to None
        # resulting in an empty list.
        if self.head == self.tail:
            self.head = None
            self.tail = None
        else:
            # Update the prev pointer of the current tail's next node to None
    ...
    def remove(self, value):
        ...
        while current is not None:
            ...
            if current.data == value:
                # If the current node is the head, remove it using remove_head()
                if current == self.head:
                    self.remove_head()
                # If the current node is the tail, remove it using remove_tail()
                ...
                # Break the loop after removing the node
                break
